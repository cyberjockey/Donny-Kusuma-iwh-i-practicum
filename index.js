...
app.get('/', async (req, res) => {
    const customObjectsUrl = 'https://api.hubapi.com/crm/v3/objects/2-36517265?properties=dino_name,dino_paddock,dino_dietary_type'; // Add required fields as query parameters
    const headers = {
...
app.post('/update-cobj', async (req, res) => {
    const newRecord = {
        properties: {
            dino_name: req.body.dino_name, // Custom field 1
            dino_paddock: req.body.dino_paddock, // Custom field 2
            dino_dietary_type: req.body.dino_dietary_type  // Custom field 3
        }
    };
